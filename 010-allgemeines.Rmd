...
- **Daten auswerten** / Hypothesen testen`r if(lec){": Bildung von Indizes, Itemanalysen, Skalenwerten; Univariate Statistiken (Statistik, die nur eine Variable verwendet, z.B. die Ermittlung der Zahl der Personen, die unter der Armutsgrenze leben); Zusammenhangsanalysen"}`
